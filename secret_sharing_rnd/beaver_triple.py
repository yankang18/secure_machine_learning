...
from secret_sharing_rnd.util import generate_random_matrix, generate_random_3_dim_matrix
...
def fill_beaver_triple_shape(mul_ops: dict, *, op_id, X_shape, Y_shape, batch_size, mul_type, batch_axis=0):
